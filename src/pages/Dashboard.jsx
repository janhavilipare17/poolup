    ...
    <div style={styles.wrapper}>
      <div style={styles.inner}>
        ...
        <div style={styles.header}>
          <div style={styles.pageTitle}>My Dashboard</div>
        ...
        <div style={styles.statsRow}>
          {[
            ...
            { icon: '💰', value: `$${totalContributed}`, label: 'Total Contributed', color: '#7c3aed' },
            { icon: '✅', value: completedGoals, label: 'Goals Completed', color: '#06d6a0' },
            { icon: '⚡', value: totalTx, label: 'Transactions', color: '#f59e0b' },
          ].map((s, i) => (
            <div key={i} style={{ ...styles.statCard, borderLeftColor: s.color }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={styles.goalAmounts}>
                      <span style={styles.goalCollected}>${goal.collected}</span>
                  ...
                  {myGoals.flatMap(g =>
                    g.contributors.map((c, i) => (
                      <tr key={i} style={styles.tr}>
                        ...
                        <td style={{ ...styles.td, fontWeight: 600, color: '#06d6a0' }}>${c.amount}</td>
...
const styles = {
  ...
  inner: { maxWidth: '1100px', margin: '0 auto', padding: '2rem 2rem 4rem' },
  ...
  statsRow: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2.5rem' },
  statCard: { background: '#111827', border: '1px solid #1e2d47', borderLeft: '3px solid', borderRadius: '16px', padding: '1.5rem' },
  statIcon: { fontSize: '24px', marginBottom: '.75rem' },
  statValue: { fontFamily: "'Syne', sans-serif", fontSize: '2rem', fontWeight: 800, marginBottom: '.2rem' },
  ...
  goalsRow: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '1rem' },
  ...
  th: { padding: '.75rem 1.5rem', textAlign: 'left', fontSize: '11px', color: '#4a5a7a', textTransform: 'uppercase', letterSpacing: '.06em', borderBottom: '1px solid #1e2d47', fontWeight: 600 },
  tr: { transition: '.15s' },
  td: { padding: '.9rem 1.5rem', borderBottom: '1px solid rgba(30,45,71,.5)', fontSize: '13px', color: '#f0f4ff' },
  ...
  txHash: { fontFamily: 'monospace', fontSize: '12px', color: '#4f8ef7' },
